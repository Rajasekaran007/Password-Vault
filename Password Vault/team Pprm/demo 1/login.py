...
class Login(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Label(self, text="TEAM PPRM", font=("orbitron", 45, "bold"),
                 foreground="black", background="#00FFFF").pack(pady=25)
        tk.Label(self, height=4, bg="#00FFFF").pack()
        tk.Label(self, text="Enter your Email Address", font=("orbitron", 13),
                 fg="black", bg="#00FFFF").pack(pady=10)
